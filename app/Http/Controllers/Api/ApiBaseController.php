...
class ApiBaseController extends Controller
{
    ...
    {
        return response()->json(['status' => true,'message' => $message,'status_code' => $statusCode],$statusCode);
    }

    public function successData($message, $data = [], int $statusCode)
    {
        return response()->json(['status' => true,'message' => $message,'status_code' => $statusCode, 'data' => $data],$statusCode);
    }
